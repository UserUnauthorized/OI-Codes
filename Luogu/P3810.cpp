...
const std::function<bool(ElementReference, ElementReference)> compareA = [](ElementReference a,
                                                                            ElementReference b) -> bool {
    if (a.a != b.a)
        return a.a < b.a;
...
const std::function<bool(ElementReference, ElementReference)> compareB = [](ElementReference a,
                                                                            ElementReference b) -> bool {
    if (a.b != b.b)
        return a.b < b.b;
